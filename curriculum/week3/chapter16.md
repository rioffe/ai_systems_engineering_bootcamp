...
Context:
The service already depends on PostgreSQL.
...
Consequences:
- retrieval scale limited by PostgreSQL architecture
- fewer infrastructure components
```

This matters because an agent operating without architectural context may repeatedly make locally reasonable but globally inconsistent decisions.

ADRs provide **persistent architectural memory**.

---

# 11. Specification Layers

A mature specification can be layered.
...
```text
      ...
      Intent          Behavior        Constraints
        │                │                │
        ↓                ↓                ↓
   Requirements    Acceptance       Performance
                    Criteria          Security
                                      Cost
                         │
                         ↓
