...
DRILLS = {
    ...
    "retrieval_failure": {"policy": "never_final", "expected": "goal_complete"},
    "duplicate_searches": {"policy": "never_final", "expected": "repeated_state"},
    "contradictory_sources": {"policy": None, "expected": "goal_complete"},
    "low_quality_sources": {"policy": None, "expected": "goal_complete"},
    "infinite_loop": {"policy": "never_final", "expected": "repeated_state"},
