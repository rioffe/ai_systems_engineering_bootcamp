...
tests/               # SPEC §9: 18 files / 150 tests, fully offline
...
`uv run pytest` is the §9 acceptance suite: **18 files / 150 tests, fully offline, ~0.2s**
...
loguru wiring, the embed request/response contract, the judge verdict bounds/retry path,
and the GUI degrade path.
