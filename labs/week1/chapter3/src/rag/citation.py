...
from rag.types import Answer, Citation, ScoredChunk
...
_INJECTION_PATTERNS: list[re.Pattern[str]] = [
    ...
    re.compile(r"ignore the (?:rules|instructions|policy)", re.IGNORECASE),
...
class InjectionResult:
    ...
    def __init__(self, warning: bool, offending: list[str] | None = None) -> None:
